...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<CustomerError> mustBeGraterThanZeroException(RuntimeException exception){
        log.info("Must be grater than zero exception occurred");
        return ResponseEntity.status(HttpStatus.CONFLICT)
                .body(CustomerError.builder()
    ...
    public ResponseEntity<CustomerError> nameCannotBeEmptyException(RuntimeException exception){
    ...
    public ResponseEntity<CustomerError> notFoundException(RuntimeException exception){
